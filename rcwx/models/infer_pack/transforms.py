"""Piecewise Rational Quadratic Transform for Normalizing Flows."""
...
def searchsorted(bin_locations: torch.Tensor, inputs: torch.Tensor, eps: float = 1e-6):
    """Search sorted with small eps for numerical stability."""
    bin_locations[..., -1] += eps
...
def rational_quadratic_spline(
    ...
    """Rational quadratic spline core implementation."""
